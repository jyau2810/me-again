...
- 待确认：扶手终止位置、座椅乘坐空间和人物承载关系；公交结构、道路方向与三个叠加预留区。
...
2. 确认 `bg_c01_s02_bus_night_layout_v003.png` 的扶手终止位置、固定座椅乘坐空间及人物承载关系，并确认公交结构、双向道路、右侧同向远离车辆，以及成年人物/手机、焦点车车灯、焦点车车牌三个叠加预留区。
