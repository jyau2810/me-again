...
- 状态：`candidate`
- 当前结果：在左下恢复朝车前方的深蓝灰布面座椅，靠背、坐垫、下方支撑以及与竖向黄杆和前景护栏的遮挡关系可读；不包含人物、儿童倒影、手机或近处焦点车。
- 校准结论：Godot 实帧中座椅位于成年人物原占位下方，`phone` 仍在座椅右上方的手部/腿部预留区，`window`、`headlight`、`plate` 未漂移，本轮保留既有坐标；正式人物的骨盆与坐垫接触、背部由靠背承接，分层合成后再次人工校正。
- 待确认：恢复的座椅方向、尺寸和承载关系；公交结构与道路透视；右侧车辆车尾方向；三个叠加预留区。
...
2. 确认 `bg_c01_s02_bus_night_layout_v002.png` 恢复的固定座椅及其承载关系，并确认公交结构、双向道路、右侧同向远离车辆，以及成年人物/手机、焦点车车灯、焦点车车牌三个叠加预留区。
