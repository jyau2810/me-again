...
| Stage 3 单幕样板 | `../game/assets/art/production/c01_s02_commute_window/`、`../game/assets/art/style-studies/c01_s02/` | 背景、结构、成人、手机、车辆状态与约五岁儿童倒影已逐项确认并分层接入；下一步评审局部冷暖效果 |
...
- 交互系统：251 条断言、17 类契约自检通过，包含 JSON 场景背景、完整画布热点、七张运行时视觉层、跨层手机目标视觉、人物/车灯/车牌/儿童状态切换、倒影样式与玻璃遮罩、车辆分层、裁切坐标、雨纹层级、旧布局回退和视觉/命中尺寸分离检查。
