...
当前评审状态：2026-08-10，用户选定原 C v001 的视觉语言、镜头和交通空间作为唯一参考，尤其确认焦点黑车迎面、右侧红车同向远离的车辆方向。该图人物身份错误，因此状态为 `reference_only`，不是正式资产。A/B/C v002 不再采用；v003 因儿童朝向和动作没有形成镜像关系被拒绝，v004 又错误地把儿童整个身体转向左侧；v005 的身体方向已正确，但倒影越过玻璃且儿童服装、手机和表情不合适；v006 完成边界、服装与空手修正，但表情读成尬笑且倒影过实。改用松弛眉眼与弱反射的 `direction_selected_v007.png` 为当前 `candidate`。
...
人物纠正版候选：`../game/assets/art/style-studies/c01_s02/direction_selected_v007.png`

状态：视觉语言与构图方向已选定；v007 等待确认后进入分层构图灰稿。
...
- 轻快感来自松弛眉眼、自然关注与轻微面颊变化，嘴部保持放松和轻微不对称，不使用标准嘴角上扬、抿嘴笑、面对镜头式微笑或夸张笑容。
- 不允许把儿童整个身体转成左侧面，也不允许使用独立视线、明显偏低的站立位置、成人化衣着、疲惫严肃神情或僵硬尬笑。
- 不使用可爱吉祥物比例，不放大眼睛或头部来制造幼态。
- 倒影以运行时低不透明度、低饱和度、低局部对比、柔和边缘、混合模式和暖光控制，让雨滴、车灯与街景穿过人物；不把固定半透明效果烘焙进背景。合成时必须使用车窗玻璃内轮廓硬遮罩，任何儿童像素不得覆盖窗框、金属窗台或车厢实体表面。
